...
| **Alta** | `PA-30` — La infraestructura elegida **no sostiene los SLA ya decididos**: sobre un nodo único no hay redundancia, ni región alternativa, ni réplica. ¿Se ajusta lo publicado, se dota de redundancia, o se negocia Enterprise caso por caso? **No reabre `PA-09`** — los números (99.0/99.5/99.9) están decididos; lo que falta es si la infra los alcanza. Detalle en [`ESC-001`](../docs/escalaciones/ESC-001-sla-sobre-nodo-unico.md), origen en [`ADR-023`](../docs/adr/ADR-023-despliegue-sobre-vps-con-docker-compose.md) §Conflicto declarado con N3 | Contratos Enterprise, créditos por incumplimiento, compromiso de DR | **Dirección + SRE** |
